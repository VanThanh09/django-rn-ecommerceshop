    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rep_cmt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eshopapis.commentuser')),
            ],
        ),
        migrations.CreateModel(
            name='Conversation',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eshopapis.productvariant'),
        ),
        migrations.CreateModel(
            name='CartDetail',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('star', models.SmallIntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ('product', models.ManyToManyField(related_name='ratings', through='eshopapis.ProductRating', to='eshopapis.product')),
            ],
        ),
        migrations.AddField(
            model_name='productrating',
            name='rating_star',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eshopapis.rating'),
        ),
        migrations.CreateModel(
            name='Store',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temp_store_logo', cloudinary.models.CloudinaryField(max_length=255)),
