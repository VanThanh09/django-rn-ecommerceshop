...
const Item = ({item}) => {
    ...
    return (
        <Pressable style={itemStyles.card} onPress={() => nav.navigate('productDetail', {productId:item.id, productLogo:item.logo})}>
    ...
    return (
        <View style={{flex: 1}}>
            <View style={styles.headerContainer}>
                <Pressable style={styles.imageContainer} onPress={() => navigation.navigate('productDetail', {productId:product.id, productLogo:product.logo})} >
